...
| ----- | ------------------------- | ------------------- | ---------------- | ----------------------- |
| 1     | `problem`, `path-problem` | `high`, `very-high` | _(any)_          | must contain `security` |
| 2     | `problem`, `path-problem` | `medium`            | _(any)_          | must contain `security` |
